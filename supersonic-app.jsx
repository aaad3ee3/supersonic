...
var RASHQ_PLATFORMS = [
  {
    ...
    Icon: Instagram,
    services: [
      { id: 401, name: "متابعين انستا 👥|حقيقي سرعة🔥|بدون ضمان", min: 100, max: 1000000, base: 0.532 },
      { id: 402, name: "متابعين انستا 👥|حقيقي سرعة🔥|30ي♻️", min: 100, max: 1000000, base: 0.644 },
      { id: 403, name: "متابعين انستا 👥|حقيقي سرعة🔥|60ي♻️", min: 100, max: 1000000, base: 0.6579999999999999 },
      { id: 404, name: "متابعين انستا 👥|حقيقي سرعة🔥|90ي♻️", min: 100, max: 1000000, base: 0.6719999999999999 },
      { id: 405, name: "متابعين انستا 👥|حقيقي سرعة🔥|سنة♻️", min: 100, max: 1000000, base: 0.728 },
      { id: 406, name: "متابعين انستا 👥|حقيقي سرعة🔥|مدء الحياه♻️", min: 100, max: 1000000, base: 0.77 },
      { id: 522, name: "مشاركات إنستغرام✈️| سريع فوري🚀| الارخص", min: 10, max: 217545811, base: 0.012 },
      { id: 523, name: "مشاركات إنستغرام✈️| سريع فوري ضمان مدء الحياه", min: 10, max: 217545811, base: 0.012750000000000001 },
      { id: 543, name: "• 👥 متابعين انستا|جودة عالية ✅️ | الارخص 🔥", min: 100, max: 5000000, base: 0.448 },
      { id: 544, name: "• 👥 متابعين انستا|ثابت 30 يوم 🚀 | الارخص 🔥", min: 100, max: 5000000, base: 0.518 },
      { id: 545, name: "• 👥 متابعين انستا|ثابت 60 يوم 🚀 | الارخص 🔥", min: 100, max: 5000000, base: 0.532 },
      { id: 546, name: "• 👥 متابعين انستا|ثابت 90 يوم 🚀 | الارخص 🔥", min: 100, max: 5000000, base: 0.546 },
      { id: 547, name: "• 👥 متابعين انستا|ثابت 365 يوم 🚀 | الارخص 🔥", min: 100, max: 5000000, base: 0.602 },
      { id: 548, name: "• 👥 متابعين انستا|ثابت مدى الحياة 🚀 | الارخص 🔥", min: 100, max: 5000000, base: 0.63 },
      { id: 274, name: "متابعين إنستجرام👥 فوري🔥 الارخص♻️", min: 100, max: 1000000, base: 0.43004 },
      { id: 275, name: "متابعين إنستجرام👥 فوري🔥 ضمان30ي♻️", min: 100, max: 1000000, base: 0.47775 },
      { id: 276, name: "متابعين إنستجرام👥 فوري🔥 ضمان60ي♻️", min: 100, max: 1000000, base: 0.51363 },
      { id: 277, name: "متابعين إنستجرام👥 فوري🔥 ضمان90ي♻️", min: 100, max: 1000000, base: 0.53755 },
      { id: 278, name: "متابعين إنستجرام👥 فوري🔥 ضمان سنة♻️", min: 100, max: 1000000, base: 0.5733 },
      { id: 279, name: "متابعين إنستجرام👥 فوري🔥 مدى الحياه♻️", min: 100, max: 1000000, base: 0.60918 },
      { id: 280, name: "متابعين إنستغرام قديمة👥 | سرييع🚀 ضمان90ي♻️", min: 50, max: 100000, base: 0.83616 },
      { id: 281, name: "متابعين إنستغرام قديمة👥 | سرييع🚀 ضمان365ي♻️", min: 50, max: 100000, base: 0.8958300000000001 },
      { id: 282, name: "متابعين إنستغرام قديمة👥 | سرييع🚀 مدى الحياه♻️", min: 50, max: 100000, base: 0.95563 },
      { id: 283, name: "لايكات إنستجرام❤️ | يصل فوري ✨ مدى الحياة♻️", min: 10, max: 1000000, base: 0.04004 },
      { id: 285, name: "مشاهدات ستوري انستا👁️ | لكل القصص🔥", min: 10, max: 15000, base: 0.10751 },
      { id: 286, name: "مشاهدات ريلز انستا🎥 | الارخص 🔥", min: 100, max: 217545811, base: 0.00182 },
      { id: 540, name: "💬 رشق تعليقات انستقرام | عشوائية سريع 🚀", min: 50, max: 100000, base: 0.45024 },
      { id: 541, name: "💬 رشق تعليقات انستقرام | عشوائية ثابت ♻️", min: 50, max: 100000, base: 0.50162 },
    ]
  },
  {
    key: "tiktok",
    ...
    Icon: Music2,
    services: [
      { id: 139, name: "👁 مشاهدات تيك توك سريع ثابت30ي☄", min: 100, max: 217545811, base: 0.018 },
      { id: 130, name: "لايكات تيك توك ثابت 30 يوم ❤️", min: 50, max: 5000000, base: 0.08499999999999999 },
      { id: 131, name: "لايكات تيك توك ثابت سنة ❤️", min: 50, max: 5000000, base: 0.09 },
      { id: 132, name: "متابعين تيك توك فوري🚀بدون تعويض👥", min: 10, max: 1000000, base: 1.976510067114094 },
      { id: 133, name: "متابعين تيكتوك فوري |تعويض10ايام👥", min: 10, max: 1000000, base: 1.8300653594771243 },
      { id: 134, name: "متابعين تيكتوك فوري |تعويض15يوم👥", min: 10, max: 1000000, base: 1.9936708860759493 },
      { id: 135, name: "متابعين تيكتوك فوري| تعويض30يوم👥", min: 10, max: 1000000, base: 2.2941176470588234 },
      { id: 160, name: "☆متابعين تيكتوك سريع ضمان 7ي👥🚀", min: 10, max: 1000000, base: 1.5 },
      { id: 161, name: "☆متابعين تيكتوك سريع ضمان 15ي👥🚀", min: 10, max: 1000000, base: 1.59 },
      { id: 162, name: "☆متابعين تيكتوك سريع ضمان 20ي👥🚀", min: 10, max: 1000000, base: 1.7 },
      { id: 163, name: "☆متابعين تيكتوك سريع ضمان 30ي👥🚀", min: 10, max: 1000000, base: 1.9344927536231884 },
      { id: 185, name: "لايكات بث تيك توك⚡فوري", min: 50, max: 217545811, base: 0.036000000000000004 },
      { id: 186, name: "لايكات تيك توك♥️ جودة⚡فوري ضمان♻️", min: 10, max: 1000000, base: 0.32 },
      { id: 268, name: "لايكات تيك توك سريع الوصول❤️ | ثابت✅", min: 10, max: 1000000, base: 0.22499999999999998 },
      { id: 549, name: "لايكات تيك توك❤️|تعمل وسريعة🚀|90يوم✅", min: 10, max: 1000000, base: 0.378 },
      { id: 550, name: "لايكات تيك توك❤️|تعمل وسريعة🚀|ضمان سنة✅", min: 10, max: 1000000, base: 0.392 },
      { id: 551, name: "لايكات تيك توك❤️|تعمل وسريعة🚀|مدء الحياه✅", min: 10, max: 1000000, base: 0.40599999999999997 },
      { id: 201, name: "متابعين تيك توك⚡👥سريع🔥 365يوم", min: 10, max: 10000000, base: 2.29 },
      { id: 427, name: "اعجابات تيكتوك | سريع 🚀 وثابت ❤️", min: 50, max: 1000000, base: 0.12042 },
      { id: 451, name: " ❤️ لايكات تيكتوك | سريع 🚀", min: 1, max: 10000000, base: 0.19845 },
      { id: 452, name: " ❤️ لايكات تيكتوك |ضمان 30 يوم سريع 🚀", min: 1, max: 10000000, base: 0.21087 },
      { id: 453, name: " ❤️ لايكات تيكتوك |ضمان 60 يوم سريع 🚀", min: 1, max: 10000000, base: 0.22329 },
      { id: 454, name: " ❤️ لايكات تيكتوك |ضمان 90 يوم سريع 🚀", min: 1, max: 10000000, base: 0.23571 },
      { id: 455, name: " ❤️ لايكات تيكتوك |ضمان 365 يوم سريع 🚀", min: 1, max: 10000000, base: 0.24813 },
      { id: 456, name: " ❤️ لايكات تيكتوك |ضمان مدى الحياة سريع 🚀", min: 1, max: 10000000, base: 0.26055 },
      { id: 524, name: "تيكتوك|لايكات بث مباشر|الارخص🚀", min: 100, max: 217545811, base: 0.0165 },
      { id: 525, name: "تيكتوك|لايكات بث مباشر|سريع🚀", min: 10, max: 217545811, base: 0.0177 },
      { id: 428, name: " 👥 متابعين تيكتوك | الأرخص 🚀", min: 10, max: 50000, base: 2.025 },
      { id: 429, name: " 👥 متابعين تيكتوك | ثابت 30 يوم 🚀", min: 10, max: 50000, base: 2.2275 },
      { id: 430, name: " 👥 متابعين تيكتوك | ثابت 60 يوم 🚀", min: 10, max: 50000, base: 2.43 },
      { id: 431, name: " 👥 متابعين تيكتوك | ثابت 90 يوم 🚀", min: 10, max: 50000, base: 2.6325 },
      { id: 432, name: " 👥 متابعين تيكتوك | ثابت سنة 🚀", min: 10, max: 50000, base: 2.835 },
      { id: 435, name: "👁 مشاهدات تيكتوك بث مباشر | الأسرع 🔥.", min: 50, max: 100000, base: 0.37935 },
      { id: 450, name: "مشاهدات تيك توك👁️|اكتمال فوري🔥|الأرخص💸", min: 100, max: 2147483647, base: 0.015525 },
      { id: 457, name: "👥 متابعين تيكتوك | امريكي 🇺🇸 سريع 🚀", min: 10, max: 1000000, base: 1.63 },
      { id: 458, name: "👥 متابعين تيكتوك | امريكي 🇺🇸 ثابت 30 ي 🚀", min: 10, max: 1000000, base: 1.83 },
      { id: 459, name: "👥 متابعين تيكتوك | سريع 🚀", min: 10, max: 1000000, base: 2.282 },
    ]
  },
  {
    key: "facebook",
    ...
    Icon: Facebook,
    services: [
      { id: 363, name: "متابعين فيسبوك👥|جودة عالية🔥|بدون ضمان⚠️", min: 10, max: 10000, base: 0.296325 },
      { id: 364, name: "متابعين فيسبوك👥|جودة عالية🔥|ضمان30ي♻️", min: 10, max: 10000, base: 0.30915000000000004 },
      { id: 365, name: "متابعين فيسبوك👥|جودة عالية🔥|ضمان60ي♻️", min: 10, max: 10000, base: 0.321975 },
      { id: 366, name: "متابعين فيسبوك👥|جودة عالية🔥|ضمان90ي♻️", min: 10, max: 10000, base: 0.334935 },
      { id: 367, name: "متابعين فيسبوك👥|جودة عالية🔥|ضمان سنة♻️", min: 10, max: 10000, base: 0.34776 },
      { id: 368, name: "متابعين فيسبوك👥|جودة عالية🔥|مدء الحياه♻️", min: 10, max: 10000, base: 0.36072 },
      { id: 369, name: "متابعين فيسبوك👥|ثبات عالي⚡|بدون ضمان⚠️", min: 100, max: 1000000, base: 0.34884000000000004 },
      { id: 370, name: "متابعين فيسبوك👥|ثبات عالي⚡|ضمان30ي♻️", min: 100, max: 1000000, base: 0.36436499999999994 },
      { id: 371, name: "متابعين فيسبوك👥|ثبات عالي⚡|ضمان60ي♻️", min: 100, max: 1000000, base: 0.37989 },
      { id: 372, name: "متابعين فيسبوك👥|ثبات عالي⚡|ضمان90ي♻️", min: 100, max: 1000000, base: 0.39541499999999996 },
      { id: 373, name: "متابعين فيسبوك👥|ثبات عالي⚡|ضمان سنة♻️", min: 100, max: 1000000, base: 0.41093999999999997 },
      { id: 374, name: "متابعين فيسبوك👥|ثبات عالي⚡|مدء الحياه♻️", min: 100, max: 1000000, base: 0.42633000000000004 },
      { id: 542, name: "مشاهدات فيسبوك ريلز 👀| سريع وثابت🪄", min: 100, max: 2147483647, base: 0.023355 },
      { id: 384, name: "تفاعل فيسبوك | 👍 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 385, name: "تفاعل فيسبوك | ❤️ وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 386, name: "تفاعل فيسبوك | 🤗 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 387, name: "تفاعل فيسبوك | 😲 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 388, name: "تفاعل فيسبوك | 😂 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 389, name: "تفاعل فيسبوك | 😥 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 390, name: "تفاعل فيسبوك | 😡 وصول فوري ✨🔥", min: 10, max: 100000, base: 0.18373499999999998 },
      { id: 397, name: "اعجابات فيسبوك ❤️| ثابت 30 يوم وسريع 🔥", min: 10, max: 1000000, base: 0.40932 },
      { id: 398, name: "اعجابات فيسبوك ❤️| ثابت 90 يوم وسريع 🔥", min: 10, max: 1000000, base: 0.42174 },
      { id: 399, name: "اعجابات فيسبوك ❤️| ثابت 365 يوم وسريع 🔥", min: 10, max: 1000000, base: 0.44658 },
      { id: 400, name: "اعجابات فيسبوك ❤️| ثابت مدى الحياة وسريع 🔥", min: 10, max: 1000000, base: 0.459 },
    ]
  },
  {
    key: "telegram",
    ...
    Icon: Send,
    services: [
      { id: 287, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان7ي♻️", min: 1, max: 1000000, base: 0.155115 },
      { id: 288, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان30ي♻️", min: 1, max: 1000000, base: 0.23571 },
      { id: 289, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان60ي♻️", min: 1, max: 1000000, base: 0.35964000000000007 },
      { id: 290, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان90ي♻️", min: 1, max: 1000000, base: 0.39703499999999997 },
      { id: 291, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان180ي♻️", min: 1, max: 1000000, base: 0.40932 },
      { id: 292, name: "أعضاء تيليجرام👥ثابت وسريع🔥|ضمان سنة♻️", min: 1, max: 1000000, base: 0.459 },
      { id: 293, name: "أعضاء تيليجرام👥ثابت وسريع🔥|مدء الحياة♻️", min: 1, max: 1000000, base: 0.496125 },
      { id: 294, name: "رشق بوت تيليجرام🤖سريع🔥|مدىالحياة♻️", min: 1, max: 100000, base: 0.22329 },
      { id: 295, name: "أعضاء تيليجرام👥 سرعة🔥 بدون ضمان", min: 1, max: 1000000, base: 0.07124 },
      { id: 296, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان7ي♻️", min: 1, max: 1000000, base: 0.08694 },
      { id: 297, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان15ي♻️", min: 1, max: 1000000, base: 0.099225 },
      { id: 298, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان30ي♻️", min: 1, max: 1000000, base: 0.18603 },
      { id: 299, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان60ي♻️", min: 1, max: 1000000, base: 0.23571 },
      { id: 300, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان90ي♻️", min: 1, max: 1000000, base: 0.285255 },
      { id: 301, name: "أعضاء تيليجرام👥|نزول خفيف🔥|ضمان سنة♻️", min: 1, max: 1000000, base: 0.34722 },
      { id: 376, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |الارخص 🔥", min: 10, max: 100000, base: 1.252395 },
      { id: 377, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان 30 يوم🔥", min: 10, max: 100000, base: 1.40265 },
      { id: 378, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان 60 يوم🔥", min: 10, max: 100000, base: 1.5654599999999999 },
      { id: 379, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان 90 يوم🔥", min: 10, max: 100000, base: 1.6280999999999999 },
      { id: 380, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان 180 يوم🔥", min: 10, max: 100000, base: 1.690605 },
      { id: 381, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان 365 يوم🔥", min: 10, max: 100000, base: 1.753245 },
      { id: 382, name: "👥 أعضاء تيليجرام عرب 🇸🇦 |ضمان مدى الحياة 🔥", min: 10, max: 100000, base: 1.87866 },
      { id: 467, name: "تفاعل تيلجرام ميكس إيجابي [👍🤩🎉🔥❤️🥰👏🏻❤️‍🔥💯] + مشاهدات 👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 468, name: "تفاعل تيلجرام ميكس سلبي [🖕💔👎😢💩🤮🤬😡🥱] + مشاهدات 👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 469, name: "تفاعل تيلجرام [ 👍 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 470, name: "تفاعل تيلجرام [ 👎 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 471, name: "تفاعل تيلجرام [ ❤️ ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 472, name: "تفاعل تيلجرام [ 🔥 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 473, name: "تفاعل تيلجرام [ 🥰 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 474, name: "تفاعل تيلجرام [ 😍 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 475, name: "تفاعل تيلجرام [ 👏 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 476, name: "تفاعل تيلجرام [ 😁 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 477, name: "تفاعل تيلجرام [ 🤔 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 478, name: "تفاعل تيلجرام [ 🤯 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 479, name: "تفاعل تيلجرام [ 😱 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 480, name: "تفاعل تيلجرام [ 🤬 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 481, name: "تفاعل تيلجرام [ 😢 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 482, name: "تفاعل تيلجرام [ 🎉 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 483, name: "تفاعل تيلجرام [ 🤩 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 484, name: "تفاعل تيلجرام [ 🤮 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 485, name: "تفاعل تيلجرام [ 💩 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 486, name: "تفاعل تيلجرام [ 🙏 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 487, name: "تفاعل تيلجرام [ 👌 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 488, name: "تفاعل تيلجرام [ 🕊 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 489, name: "تفاعل تيلجرام [ 🌚 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 490, name: "تفاعل تيلجرام [ 💯 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 491, name: "تفاعل تيلجرام [ 🤣 ] + مشاهدات👁️🔥", min: 10, max: 100000, base: 0.015540000000000002 },
      { id: 492, name: "تفاعل تيلجرام [ ⚡️ ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 493, name: "تفاعل تيلجرام [ 🥱 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 494, name: "تفاعل تيلجرام [ 🍌 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 495, name: "تفاعل تيلجرام [ 🏆 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 496, name: "تفاعل تيلجرام [ 💔 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 497, name: "تفاعل تيلجرام [ 🤨 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 498, name: "تفاعل تيلجرام [ 🖕 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 499, name: "تفاعل تيلجرام [ 😈 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 500, name: "تفاعل تيلجرام [ 😡 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 501, name: "تفاعل تيلجرام [ 😴 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 502, name: "تفاعل تيلجرام [ 😭 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 503, name: "تفاعل تيلجرام [ 👀 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 504, name: "تفاعل تيلجرام [ 🙈 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 505, name: "تفاعل تيلجرام [ 🫡 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 506, name: "تفاعل تيلجرام [ 🆒 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 507, name: "تفاعل تيلجرام [ 💘 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 508, name: "تفاعل تيلجرام [ 😘 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 509, name: "تفاعل تيلجرام [ 💖 ] + مشاهدات👁️🔥", min: 10, max: 217545811, base: 0.015540000000000002 },
      { id: 460, name: "نجوم تليجرام تفاعل منشور ⭐️| فوري تلقائي♻️", min: 1, max: 10000, base: 26.286 },
      { id: 461, name: "نجوم تليجرام للحساب ⭐️| تسليم فوري تلقائي ♻️", min: 50, max: 10000, base: 26.286 },
    ]
  },
  {
    key: "youtube",
    ...
    Icon: Youtube,
    services: [
      { id: 269, name: "👥️ متابعين يوتيوب الارخص | سريع 🔥", min: 200, max: 100000, base: 0.30000000000000004 },
      { id: 270, name: "👍🏻 لايكات يوتيوب الارخص | ضمان 30 يوم ❤️", min: 10, max: 20000, base: 0.48 },
      { id: 271, name: "👍🏻 لايكات يوتيوب الارخص | ضمان 60 يوم ❤️", min: 10, max: 100000, base: 0.495 },
      { id: 272, name: "👍🏻 لايكات يوتيوب الارخص | ضمان 365 يوم ❤️", min: 10, max: 100000, base: 0.51 },
      { id: 273, name: "👍🏻 لايكات يوتيوب الارخص | ضمان مدى الحياة ❤️", min: 10, max: 100000, base: 0.5249999999999999 },
    ]
  },
  {
    key: "whatsapp",
    ...
    Icon: MessageCircle,
    services: [
      { id: 140, name: "أعضاء قناة واتساب حقيقيون👥", min: 10, max: 10000, base: 2.5 },
      { id: 141, name: "متابعين قناه واتساب حقيقي هندي 🇮🇳", min: 10, max: 100000, base: 4 },
      { id: 142, name: "متابعين قناه واتساب عرب 🇸🇦", min: 10, max: 100000, base: 4 },
      { id: 143, name: "متابعين قناه واتساب تركيا 🇹🇷 ", min: 10, max: 100000, base: 4 },
      { id: 421, name: "تفاعل قناه واتساب 😂 | سرعة برق⚡️🔥.", min: 10, max: 100000, base: 1.10214 },
      { id: 414, name: "تفاعل واتساب 👏", min: 10, max: 100000, base: 1.10214 },
      { id: 415, name: "تفاعل واتساب 🔥", min: 10, max: 100000, base: 1.10214 },
      { id: 416, name: "تفاعل واتساب 🏆", min: 10, max: 100000, base: 1.10214 },
      { id: 417, name: "تفاعل واتساب 🎉", min: 10, max: 100000, base: 1.10214 },
      { id: 419, name: "تفاعل قناه واتساب عشوائي 👍❤️🔥🎉😁 تركي 🇹🇷 ", min: 10, max: 50000, base: 1.1272499999999999 },
      { id: 420, name: "تفاعل قناه واتساب عشوائي 👍❤️🔥🎉😁 هندي 🇮🇳 ", min: 10, max: 50000, base: 1.1272499999999999 },
      { id: 526, name: "تفاعل قناه واتساب عشوائي 👍❤️🔥🎉😁", min: 10, max: 10000, base: 0.8876 },
      { id: 527, name: "تفاعل قناه واتساب 👍 | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 528, name: "تفاعل قناه واتساب ❤️ | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 529, name: "تفاعل قناه واتساب 😄 | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 530, name: "تفاعل قناه واتساب 😮 | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 531, name: "تفاعل قناه واتساب 😢 | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 532, name: "تفاعل قناه واتساب 🙏 | سرعة برق⚡️🔥.", min: 10, max: 10000, base: 0.8876 },
      { id: 538, name: "👥 أعضاء قناة واتساب حقيقي |سريع🚀| الارخص 🔥", min: 10, max: 10000, base: 2.219 },
      { id: 539, name: "👥 أعضاء قناة واتساب امريكي 🇺🇸|سريع🚀| الارخص 🔥", min: 10, max: 10000, base: 2.219 },
    ]
  },
  {
    key: "twitter",
    ...
    Icon: AtSign,
    services: [
      { id: 53, name: "متابعين تويتر عالية الجودة عالمي  متنوع🚀", min: 100, max: 50000, base: 1.6500000000000001 },
      { id: 54, name: "متابعين حقيقيين تويتر | اليابان 🇯🇵", min: 100, max: 50000, base: 1.365 },
      { id: 55, name: "متابعين تويتر حقيقيين | كوريا 🇰🇷 ", min: 100, max: 50000, base: 1.365 },
      { id: 56, name: "متابعين تويتر حقيقيين | تركيا 🇹🇷 ", min: 100, max: 50000, base: 1.365 },
      { id: 57, name: "متابعين تويتر حقيقيين | انجلترا 🇬🇧 ", min: 100, max: 50000, base: 1.365 },
    ]
  },
  {
    key: "other",
    ...
    Icon: Users,
    services: [
      { id: 52, name: "متابعين👥 وصول سريع🚀|رخيص بدون ضمان", min: 10, max: 10000, base: 0.8999999999999999 },
      { id: 58, name: "متابعين حقيقيين🙎‍♂️انخفاض قليل سريع ضمان30 ي♻️", min: 10, max: 10000, base: 6.5 },
      { id: 136, name: "متابعين ثابت 100% ضمان 60يوم 👥✅", min: 5, max: 30000, base: 4.95 },
      { id: 214, name: "إعجابات مخفية♥️ | سريع⚡| 30 يوم♻️", min: 10, max: 1000000, base: 0.123 },
      { id: 215, name: "إعجابات مخفية♥️ | سريع⚡| 90 يوم♻️", min: 10, max: 1000000, base: 0.126 },
      { id: 216, name: "إعجابات مخفية♥️ | سريع⚡| 365يوم♻️", min: 10, max: 1000000, base: 0.129 },
      { id: 217, name: "إعجابات مخفية♥️ | سريع⚡| مدى الحياه♻️", min: 10, max: 1000000, base: 0.1305 },
      { id: 228, name: "متابعون 👥| جودة عالية⭐|سريع |30ي♻️", min: 10, max: 500000, base: 2.0416666666666665 },
      { id: 229, name: "متابعون 👥| جودة عالية⭐|سريع |بدون♻️", min: 10, max: 500000, base: 1.232 },
      { id: 230, name: "متابعون 👥| جودة عالية⭐|سريع⚡|7ي♻️", min: 10, max: 500000, base: 1.4 },
      { id: 231, name: "متابعون 👥| جودة عالية⭐|سريع⚡|15ي♻️", min: 10, max: 500000, base: 1.5368181818181816 },
      { id: 232, name: "متابعون 👥| جودة عالية⭐|سريع⚡|20ي♻️", min: 10, max: 500000, base: 1.673913043478261 },
      { id: 510, name: "متابعين حسابات حقيقه👥| الارخص |سريع🔥", min: 100, max: 1000000, base: 0.49 },
      { id: 511, name: "متابعين حسابات حقيقه👥|ثابت30ي🚀|سريع🔥", min: 100, max: 1000000, base: 0.56 },
      { id: 512, name: "متابعين حسابات حقيقه👥|ثابت60ي🚀|سريع🔥", min: 100, max: 1000000, base: 0.574 },
      { id: 513, name: "متابعين حسابات حقيقه👥|ثابت90ي🚀|سريع🔥", min: 100, max: 1000000, base: 0.588 },
      { id: 514, name: "متابعين حسابات حقيقه👥|ثابت365ي🚀|سريع🔥", min: 100, max: 1000000, base: 0.63 },
      { id: 515, name: "متابعين حسابات حقيقه👥|ثابت مدى الحياة 🚀|سريع🔥", min: 100, max: 1000000, base: 0.6719999999999999 },
      { id: 516, name: "متابعين حسابات قديمة 👥|الارخص🏆|سريع🚀", min: 10, max: 1000000, base: 0.63 },
      { id: 517, name: "متابعين حسابات قديمة 👥|ثابت30ي🏆|سريع🚀", min: 10, max: 1000000, base: 0.7 },
      { id: 518, name: "متابعين حسابات قديمة 👥|ثابت60ي🏆|سريع🚀", min: 10, max: 1000000, base: 0.714 },
      { id: 519, name: "متابعين حسابات قديمة 👥|ثابت90ي🏆|سريع🚀", min: 10, max: 1000000, base: 0.728 },
      { id: 520, name: "متابعين حسابات قديمة 👥|ثابت365ي🏆|سريع🚀", min: 10, max: 1000000, base: 0.77 },
      { id: 521, name: "متابعين حسابات قديمة 👥|ثابت مدى الحياة 🏆|سريع🚀", min: 10, max: 1000000, base: 0.8119999999999999 },
      { id: 354, name: "مشاهدات👀 [ 5 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.026865 },
      { id: 355, name: "مشاهدات👀 [ 10 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.0459 },
      { id: 356, name: "مشاهدات👀 [ 15 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.06885 },
      { id: 357, name: "مشاهدات👀 [ 20 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.0918 },
      { id: 358, name: "مشاهدات👀 [ 30 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.137565 },
      { id: 359, name: "مشاهدات👀 [ 50 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.22923000000000002 },
      { id: 360, name: "مشاهدات👀 [ 100 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.458595 },
      { id: 361, name: "مشاهدات👀 [ 200 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 0.917325 },
      { id: 362, name: "مشاهدات👀 [ 500 ] منشورات مستقبلية📌", min: 10, max: 1000000, base: 2.669625 },
      { id: 391, name: "اعجابات❤️+ متابعين صفحة👥| الارخص ♻️", min: 50, max: 1000000, base: 0.3429 },
      { id: 392, name: "اعجابات❤️+ متابعين صفحة👥|ثابت 30 يوم♻️", min: 50, max: 100000, base: 0.36072 },
      { id: 393, name: "اعجابات❤️+ متابعين صفحة👥|ثابت 60 يوم♻️", min: 50, max: 1000000, base: 0.37395 },
      { id: 394, name: "اعجابات❤️+ متابعين صفحة👥|ثابت 90 يوم ♻️", min: 50, max: 1000000, base: 0.38744999999999996 },
      { id: 395, name: "اعجابات❤️+ متابعين صفحة👥|ثابت سنة♻️", min: 50, max: 1000000, base: 0.40081500000000003 },
      { id: 396, name: "اعجابات❤️+ متابعين صفحة👥|ثابت مدى الحياة ♻️", min: 50, max: 1000000, base: 0.42754499999999995 },
      { id: 433, name: "💬 رشق تعليقات | عشوائية ايموجي 🚀", min: 10, max: 10000, base: 1.1475 },
      { id: 434, name: "💬 رشق تعليقات | عشوائية سريع 🚀", min: 10, max: 10000, base: 1.1475 },
      { id: 436, name: "متابعين👥|ثبات عالي|صاروخ🔥|ضمان365ي♻️", min: 10, max: 100000, base: 0.715635 },
      { id: 437, name: "أعضاء👥|فوري🔥|ضمان3أيام♻️", min: 10, max: 100000, base: 0.050219999999999994 },
      { id: 438, name: "أعضاء👥|فوري🔥|ضمان5أيام♻️", min: 10, max: 100000, base: 0.07533000000000001 },
      { id: 439, name: "أعضاء👥|فوري🔥|ضمان7أيام♻️", min: 10, max: 100000, base: 0.07533000000000001 },
      { id: 440, name: "أعضاء👥|فوري🔥|ضمان15ي♻️", min: 10, max: 100000, base: 0.12555 },
      { id: 441, name: "أعضاء👥|فوري🔥|ضمان30ي♻️", min: 10, max: 100000, base: 0.050219999999999994 },
      { id: 442, name: "أعضاء👥|فوري🔥|ضمان60ي♻️", min: 10, max: 100000, base: 0.17577 },
      { id: 443, name: "👥أعضاء مجموعة|وصول فوري⚡|♻️مدىالحياة", min: 10, max: 1000000, base: 0.49005 },
      { id: 462, name: "متابعين👥|الأفضل🌟|سرعة🔥|ضمان30ي♻️", min: 10, max: 1000000, base: 0.27664 },
      { id: 463, name: "متابعين👥|الأفضل🌟|سرعة🔥|ضمان60ي♻️", min: 10, max: 1000000, base: 0.33194 },
      { id: 464, name: "متابعين👥|الأفضل🌟|سرعة🔥|ضمان90ي♻️", min: 10, max: 1000000, base: 0.38724000000000003 },
      { id: 465, name: "متابعين👥|الأفضل🌟|سرعة🔥|ضمان365ي♻️", min: 10, max: 1000000, base: 0.44267999999999996 },
      { id: 466, name: "متابعين👥|الأفضل🌟|سرعة🔥|مدءالحياه♻️", min: 10, max: 1000000, base: 0.49798000000000003 },
    ]
  },
];
var SECTIONS = [{
...
function Header({
  ...
  return /* @__PURE__ */<header className="sticky top-0 z-20 bg-void/80 backdrop-blur-xl border-b border-white/5 px-4 py-3 flex items-center justify-between"><div className="flex items-center gap-1.5"><span className="w-7 h-7 rounded-lg bg-gradient-to-br from-purple-500 to-purple-800 flex items-center justify-center" style={{ boxShadow: "0 0 16px rgba(124,58,237,0.5)" }}><Zap className="w-4 h-4 text-white" /></span><span className="text-lg font-black italic tracking-tight bg-gradient-to-l from-purple-400 to-white bg-clip-text text-transparent font-latin">Supersonic</span></div><div className="flex items-center gap-2"><button onClick={onSearchClick} aria-label="بحث" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center transition-colors hover:bg-white/10"><Search className="w-4 h-4 text-purple-300" /></button><button onClick={() => showToast("\u0648\u0644\u0627 \u0625\u0634\u0639\u0627\u0631 \u062C\u062F\u064A\u062F \u062D\u0627\u0644\u064A\u064B\u0627")} aria-label="الإشعارات" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center relative transition-colors hover:bg-white/10"><Bell className="w-4 h-4 text-purple-300" /><span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-accent rounded-full" /></button></div></header>;
}
function BottomNav({
  tab,
  onChange
}) {
  return /* @__PURE__ */<nav className="fixed bottom-0 inset-x-0 z-20 bg-void/80 backdrop-blur-xl border-t border-white/5" style={{
    maxWidth: 480,
    margin: "0 auto"
...
function ProductSheet({
  ...
  return /* @__PURE__ */<div className="fixed inset-0 z-30 flex items-end justify-center"><div className="absolute inset-0 bg-void" style={{
      opacity: 0.75
    }} onClick={onClose} /><div className="relative w-full bg-surface/90 backdrop-blur-xl border-t border-white/10 rounded-t-3xl p-5 pb-8 overflow-hidden" style={{
      maxWidth: 480,
      maxHeight: "85vh",
      overflowY: "auto"
...
function HomeView({
  ...
  return /* @__PURE__ */<div><div className="mx-4 mt-4 rounded-3xl bg-gradient-to-br from-purple-800 via-purple-950 to-black border border-purple-700 p-5 relative overflow-hidden h-32 flex flex-col justify-center"><div className="absolute -top-8 -left-8 w-40 h-40 rounded-full bg-purple-500/30 blur-3xl pointer-events-none" aria-hidden="true" /><div className="absolute -bottom-10 right-0 w-32 h-32 rounded-full bg-gold/15 blur-3xl pointer-events-none" aria-hidden="true" /><SpeedStreaks />{(() => {
  ...
  if (status === "paid") {
    return (
      <div className="text-center py-4">
        ...
        <p className="text-white font-bold mb-1">تم شحن <span className="text-gold font-latin">{fmt(amountPaid)} د.ل</span> بنجاح ✅</p>
        ...
        <div className="bg-purple-950 border border-purple-800 rounded-2xl p-4">
          ...
          <div className="space-y-2.5 text-xs text-gray-200">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>
                حوّل <b className="text-gold font-latin">{fmt(charge.amount)} د.ل</b> بالضبط (مو أكتر ولا أقل) لهذا الرقم:
